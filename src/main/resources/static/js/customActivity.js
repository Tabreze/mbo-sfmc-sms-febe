define([
  ...
  function initialize(data) {
	...
	//mode: "opaque",	  
	 method: "POST",
     headers: {"Content-type": "application/json, charset=UTF-8","Authorization": "Bearer " + $('#tokens'), 'Access-Control-Allow-Origin':'*',  "Access-Control-Allow-Credentials": "true", 'Access-Control-Allow-Methods':'POST,PATCH,OPTIONS'},  
		mode: 'no-cors',
