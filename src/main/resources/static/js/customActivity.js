...
fetch('https://mc-260crls51zy9yd64d27td22t8.auth.marketingcloudapis.com/v1/requestToken', 
	...
	//mode: "opaque",	  
	 method: "POST",
     headers: {"Content-type": "application/json, charset=UTF-8",'Access-Control-Allow-Origin':'*', 'Access-Control-Allow-Methods':'POST,PATCH,OPTIONS'},   
		mode: 'no-cors',
	...
	//mode: "opaque",	  
	 method: "POST",
    headers: {"Content-type": "application/json, charset=UTF-8",'Authorization': `Bearer ${requestToken}`, 'Access-Control-Allow-Origin':'*', 'Access-Control-Allow-Methods':'POST,PATCH,OPTIONS'},   
		mode: 'no-cors',
